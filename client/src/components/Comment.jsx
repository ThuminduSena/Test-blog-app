    ...
    <div className='flex p-4 border-b dark:border-gray-600 text-sm'>
        ...
        <div className="flex-1">
            ...
            </div>
            {
                isEditing ? (
                    <>
                        <Textarea className='mb-2' maxLength='200' value={editedContent} onChange={(e) => setEditedContent(e.target.value)} />
                    ...
                    <>
                        ...
                        <div className="flex items-center pt-2 text-xs border-t dark:border-color-700 max-w-fit gap-2">
