...
export default function DashboardComp() {
    ...
    const [ nonExpiredAds, setNonExpiredAds] = useState(0);
        ...
        const fetchAds = async () => {
          try {
              ...
              if(res.ok){
                  ...
                  setNonExpiredAds(data.nonExpiredAds);
              }
          } catch (error) {
              console.log(error.message);
          }
    ...
    <div className='flex-wrap flex gap-4 justify-center'>
      ...
      <div className='flex flex-col p-3 dark:bg-slate-800 gap-4 md:w-72 w-full rounded-md shadow-md'>
        ...
        <div className='flex  gap-2 text-sm'>
          ...
          <div className='text-gray-500'>Available Ads</div>
        </div>
      </div>
    </div>
            ...
            ads.map((ad) => (
              <Table.Body key={ad._id} className='divide-y'>
                <Table.Row className='bg-white dark:border-gray-700 dark:bg-gray-800'>
                  ...
                  <Table.Cell className='w-96'>{ad.title}</Table.Cell>
