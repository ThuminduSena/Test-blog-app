        ...
        <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
            <div className='flex flex-col gap-4 sm:flex-row justify-between'>
                ...
                <Select onChange = {(e) => 
                    ...
                    <option value='uncategorized'>Selecat a Category</option>
                    <option value='javascript'>Javascript</option>
                    <option value='reactjs'>React.js</option>
                    <option value='nextjs'>Next.hs</option>
                </Select>
            </div>
            ...
            <ReactQuill theme='snow' value={formData.content} placeholder = 'Write something here*' className='h-72 mb-12' required onChange={
                (value) => {
